...
@testset "Objective function and value in box constraints" begin
    ...
    @testset "Getting objective value" begin
        ...
        HiGHS.Highs_changeColCost(o.model.inner, Cint(x.value), 1.0)
    ...
    @testset "Max in box" begin
        ...
        HiGHS.Highs_changeColCost(o.model.inner, Cint(x.value), 2.0)
        MOI.optimize!(o)
    ...
    @testset "Objective function obtained from model corresponds" begin
        ...
        MOI.set(o, MOI.ObjectiveSense(), MOI.MIN_SENSE)
        HiGHS.Highs_changeColCost(o.model.inner, Cint(x1.value), 2.0)
        HiGHS.Highs_changeColCost(o.model.inner, Cint(x2.value), -1.0)
